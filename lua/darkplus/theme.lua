...
theme.set_highlights = function()
  ...
  hl(0, "DiffText", { fg = nil, bg = c.sign_delete_bg })
  hl(0, "DiffAdd", { fg = nil, bg = c.sign_add_bg })
  hl(0, "DiffChange", { fg = nil, bg = c.ui2_blue })
  hl(0, "DiffDelete", { fg = 'NONE', bg = c.sign_delete_bg })
  ...
  hl(0, "Search", { fg = 'NONE', bg = c.ui2_orange })
  hl(0, "IncSearch", { fg = 'NONE', bg = c.ui5_blue })
  ...
  hl(0, "@lsp.type.enumMember", { fg = c.vivid_blue })
  ...
  hl(0, "@lsp.typemod.property.readonly", { fg = c.vivid_blue })
  hl(0, "@lsp.typemod.variable.readonly", { fg = c.vivid_blue })
  ...
  hl(0, "GitSignsCurrentLineBlame", { fg = c.cursor_fg, bg = 'NONE' })
  hl(0, "GitBlame", { fg = c.cursor_fg, bg = 'NONE' })
  ...
  hl(0, "TelescopeBorder", { fg = c.hint, bg = 'NONE' })
  ...
  hl(0, "TelescopePromptCounter", { fg = c.magenta, bg = 'NONE' })
  hl(0, "TelescopePreviewHyphen", { fg = c.magenta, bg = 'NONE' })
  ...
  -- NeoTree
  -- hl(0, "NeoTreeBufferNumber", { link = 'Directory' })
  hl(0, "NeoTreeCursorLine", { link = 'NvimTreeCursorLine' })
  -- hl(0, "NeoTreeDimText", { link = 'Directory' })
  hl(0, "NeoTreeDirectoryIcon", { link = 'NvimTreeFolderIcon' })
  hl(0, "NeoTreeDirectoryName", { link = 'NvimTreeFolderName' })
  -- hl(0, "NeoTreeDotfile", { link = 'Directory' })
  -- hl(0, "NeoTreeFileIcon", { link = 'Directory' })
  -- hl(0, "NeoTreeFileName", { link = 'Directory' })
  -- hl(0, "NeoTreeFileNameOpened", { link = 'Directory' })
  -- hl(0, "NeoTreeFilterTerm", { link = 'Directory' })
  hl(0, "NeoTreeFloatBorder", { link = 'TelescopeBorder' })
  -- hl(0, "NeoTreeFloatTitle", { link = 'Directory' })
  -- hl(0, "NeoTreeTitleBar", { link = 'Directory' })
  hl(0, "NeoTreeGitAdded", { link = 'NvimTreeGitStaged' })
  hl(0, "NeoTreeGitConflict", { link = 'NvimTreeGitMerge' })
  ...
  hl(0, "NeoTreeGitUnstaged", { link = 'NvimTreeGitDirty' })
  hl(0, "NeoTreeGitUntracked", { link = 'NvimTreeGitNew' })
  hl(0, "NeoTreeGitStaged", { link = 'NvimTreeGitStaged' })
  -- hl(0, "NeoTreeHiddenByName", { link = 'Directory' })
  hl(0, "NeoTreeIndentMarker", { link = 'NvimTreeIndentMarker' })
  -- hl(0, "NeoTreeExpander", { link = 'Directory' })
  hl(0, "NeoTreeNormal", { link = 'NvimTreeNormal' })
  hl(0, "NeoTreeNormalNC", { link = 'NvimTreeNormal' })
  -- hl(0, "NeoTreeSignColumn", { link = 'Directory' })
  -- hl(0, "NeoTreeStatusLine", { link = 'Directory' })
  -- hl(0, "NeoTreeStatusLineNC", { link = 'Directory' })
  -- hl(0, "NeoTreeVertSplit", { link = 'Directory' })
  ...
  hl(0, "NeoTreeSymbolicLinkTarget", { link = 'NvimTreeSymlink' })
  -- hl(0, "NeoTreeTitleBar", { link = 'Directory' })
  -- hl(0, "NeoTreeWindowsHidden", { link = 'Directory' })
  ...
  hl(0, "DiffviewStatusAdded", { fg = c.sign_add_alt, bg = 'NONE' })
  hl(0, "DiffviewStatusUntracked", { fg = c.sign_add_alt, bg = 'NONE' })
  hl(0, "DiffviewStatusModified", { fg = c.sign_change_alt, bg = 'NONE' })
  hl(0, "DiffviewStatusRenamed", { fg = c.sign_change_alt, bg = 'NONE' })
  hl(0, "DiffviewStatusDeleted", { fg = c.sign_delete_alt, bg = 'NONE' })
  hl(0, "DiffviewFilePanelInsertion", { fg = c.sign_add_alt, bg = 'NONE' })
  hl(0, "DiffviewFilePanelInsertions", { fg = c.sign_add_alt, bg = 'NONE' })
  hl(0, "DiffviewFilePanelDeletion", { fg = c.sign_delete_alt, bg = 'NONE' })
  hl(0, "DiffviewFilePanelDeletions", { fg = c.sign_delete_alt, bg = 'NONE' })
  hl(0, "DiffviewVertSplit", { fg = c.alt_bg, bg = c.alt_bg })
  hl(0, "DiffviewWinSeparator", { fg = c.alt_bg, bg = c.alt_bg })
  ...
  -- Bqf
  hl(0, "BqfPreviewBorder", { fg = c.hint, bg = 'NONE' })
  ...
  hl(0, "CmpGhostText", { fg = c.gray, bg = 'NONE' })
  ...
  hl(0, "NeogitDiffAddHighlight", { fg = c.white, bg = c.sign_add_bg })
  hl(0, "NeogitDiffDeleteHighlight", { fg = c.white, bg = c.sign_delete_bg })
  ...
  -- Rainbow Delimiters
  hl(0, "RainbowDelimiter1", { fg = '#ffd700', bg = 'NONE' })
  hl(0, "RainbowDelimiter2", { fg = '#da70d6', bg = 'NONE' })
  hl(0, "RainbowDelimiter3", { fg = '#1798f3', bg = 'NONE' })
  ...
  -- Specific lang
  -- Extended from lang
  hl(0, "@keyword.await", { fg = c.purple, bg = 'NONE' })
  hl(0, "@keyword.include", { fg = c.purple, bg = 'NONE' })

  -- Typescript & Javascript
  hl(0, "@punctuation.special.typescript", { fg = c.blue, bg = 'NONE' })
  hl(0, "@punctuation.special.javascript", { fg = c.blue, bg = 'NONE' })
  hl(0, "@variable.builtin.typescript", { fg = c.cyan, bg = 'NONE' })
  hl(0, "@variable.builtin.javascript", { fg = c.cyan, bg = 'NONE' })
  hl(0, "@constructor.tsx", { fg = c.cyan, bg = 'NONE' })
  hl(0, "@constructor.jsx", { fg = c.cyan, bg = 'NONE' })
  -- Go lang
  hl(0, "@type.definition.go", { fg = c.cyan, bg = 'NONE' })
  hl(0, "@constructor.go", { fg = c.yellow, bg = 'NONE' })
  hl(0, "@keyword.coroutine.go", { fg = c.purple, bg = 'NONE' })
  -- Python
  hl(0, "@constructor.python", { fg = c.cyan, bg = 'NONE' })
  -- Dart
  hl(0, "@keyword.coroutine.dart", { fg = c.purple, bg = 'NONE' })
end
