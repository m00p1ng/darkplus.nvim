...
theme.set_highlights = function()
  ...
  hl(0, "DiffText", { fg = 'NONE', bg = c.sign_add_bg })
  hl(0, "DiffAdd", { fg = 'NONE', bg = c.sign_add_bg })
  hl(0, "DiffChange", { fg = 'NONE', bg = c.select })
  ...
  hl(0, "IncSearch", { fg = 'NONE', bg = "#9e6a02" })
  hl(0, "CurSearch", { fg = 'NONE', bg = "#9e6a02" })
  hl(0, "Substitute", { fg = 'NONE', bg = "#9e6a02" })
  ...
  hl(0, "@lsp.type.deriveHelper", { link = "@function" })
  hl(0, "@lsp.type.enum", { link = '@type' })
  hl(0, "@lsp.type.enumMember", { fg = c.blue_3 })
  ...
  hl(0, "@lsp.typemod.keyword.control", { link = '@conditional' })
  ...
  hl(0, "@lsp.typemod.source.interpolation", { link = '@punctuation.special' })
  hl(0, "@lsp.typemod.variable.injected", { link = '@variable' })
  hl(0, "@lsp.typemod.property.readonly", { fg = c.blue_3, bg = 'NONE' })
  hl(0, "@lsp.typemod.variable.readonly", { fg = c.blue_3, bg = 'NONE' })
  ...
  hl(0, "TelescopeSelectionCaret", { fg = c.red, bg = c.select })
  ...
  hl(0, "NvimTreeGitStaged", { fg = c.git_tree_add, bg = 'NONE' })
  ...
  -- DiffView
  hl(0, "DiffviewNormal", { fg = c.light_gray, bg = c.alt_bg })
  hl(0, "DiffviewStatusAdded", { fg = c.git_tree_add, bg = 'NONE' })
  hl(0, "DiffviewStatusModified", { fg = c.git_tree_change, bg = 'NONE' })
  hl(0, "DiffviewStatusRenamed", { fg = c.git_tree_change, bg = 'NONE' })
  hl(0, "DiffviewStatusDeleted", { fg = c.git_tree_delete, bg = 'NONE' })
  hl(0, "DiffviewFilePanelInsertion", { fg = c.git_tree_add, bg = 'NONE' })
  hl(0, "DiffviewFilePanelDeletion", { fg = c.git_tree_delete, bg = 'NONE' })
  ...
  hl(0, "CmpGhostText", { fg = c.light_gray, bg = 'NONE' })
  ...
  hl(0, "NavicIconsString", { fg = c.blue_1, bg = 'NONE' })
  ...
  -- Misc
  hl(0, "diffAdded", { fg = c.git_tree_add, bg = 'NONE' })
  hl(0, "diffRemoved", { fg = c.git_tree_delete, bg = 'NONE' })
  hl(0, "diffFileId", { fg = c.blue_1, bg = 'NONE', bold = true, reverse = true, })
